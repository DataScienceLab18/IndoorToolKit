...
//    cout<<"source:"<<p.get<0>()<<endl;
//    cout<<"s:"<<s<<endl;
//    cout<<"e:"<<g_.wg_.eid(e)<<endl;
//    cout<<"landmark02_:"<<landmarks_.size()<<endl;
    std::vector<std::pair<int, double> > &vec =
        landmarks_[g_.wg_.eid(e)];

//    cout<<"landmarks2_f:"<<landmarks_[g_.wg_.eid(e)][0].first<<endl;
//    cout<<"landmarks2_s:"<<landmarks_[g_.wg_.eid(e)][0].second<<endl;
...
//    cout<<"discover"<<vid<<endl;
//    cout<<"limit_"<<limit_<<endl;
//    path.push_back(vid)
    if (vid >= limit_) {
...
//  int totalVectices=g_.n2v.size();
//    cout<<"totalVectices"<<totalVectices<<endl;
//  std::vector<Vertex> p(totalVectices);
//  std::vector<int> d(totalVectices);
...
//  for (boost::tie(ei, eend) = boost::edges(boost::visitor(vis).weight_map(w0_)); ei != eend; ++ei) {
//    Vertex v = boost::source(*ei, g_.wg_());
//    Vertex u = boost::target(*ei, g_.wg_());
//    cout << g_.wg_.vid(v) << ' ' << g_.wg_.vid(u) << std::endl;
//  }
  cout<<"_______"<<endl;
...
//      cout<<"obj->"<<i->first<<":"<<i->second<<endl;
